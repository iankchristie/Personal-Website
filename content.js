...
tabs["Home"] = {
    ...
    "description": ["I grew up in Houston, Texas. I went to college near Boston, Massachussetts where I studied Computer Science and Neuroscience. Now I live in San Francisco and I'm working at Google on the YouTube Mobile Architecture team. In my spare time I run, bike, and rock climb. I want to learn everything."]
};
// Contact
tabs["Contact"] = {
    "heading": "Contact",
...
tabs["Google"] = {
    ...
    "description": ["I joined Google in September 2016 for a 1 year rotational program called an Engineering Residency, so I could make a smooth transition from academia to industry.<br/>",
        "I've found that I thrive in an environment with smart peers and challenging projects to work on."
    ]
};
// Chrome
tabs["Chrome"] = {
    ...
    "description": ["The Chrome browser was amazing to work on! It was my first experience working on a <i>civilization sized</i> product and the engineering on the team is phenomenal. I worked on an experimental project called <b>The Physical Web</b>, which was a way to introduce the <b>Internet Of Things</b> into Chrome. Specifically, I worked on Chrome for Android."]
};
// FatBeacon
tabs["FatBeacon"] = {
    "heading": "FatBeacon",
    "image": "Images/RaspberryPi3.jpg",
    "description": ["I prototyped and optimized peer-to-peer webpage transfer over BLE from Raspberry Pi 3 to Android. I achieved a transfer rate of 32.8 KB/s (7.5x faster than previous attempts)."]
};
// Sharing
tabs["Sharing"] = {
...
tabs["ShareSheet"] = {
    ...
    "description": ["I refactored the Chrome share sheet to allow for easy inclusion of generic components with intent filters."]
};
// PrototypeApp
tabs["PrototypeApp"] = {
    "heading": "Physical Web Prototype App",
    "image": "Images/Prototype.png",
    "description": ["I enhanced UX of the Physical Web prototype app by moving work off of the main thread to reduce dropped frames.<br/>",
        "Also I designed and implemented a new settings page for the app that was more user friendly and intuitive.",
        "The source code is available on my <a target=\"blank\" href=\"https://github.com/iankchristie/physical-web\">Github</a>."
    ]
};
// YouTube
tabs["YouTube"] = {
...
tabs["Migration"] = {
    ...
    "description": ["I worked on migrating iOS client infrastructure dependency injection framework between two proprietary technologies. It was in a half-assed state for a long time and my colleagues were very appreciative that I took the time to work on it."]
};
// LightweightData
tabs["LightweightData"] = {
    "heading": "Lightweight CoreData Migration Analysis",
    "image": "Images/iOS.jpg",
    "description": ["I analyzed Lightweight CoreData migration and its effect on application startup time."]
};
// GoldmanSachs
tabs["GoldmanSachs"] = {
    ...
    "description": ["I love to learn and experience new things. In 2015 I was certain that I was going to go into science or tech as a career, so I wanted to do something different with my summer. I chose to intern at the investment bank Goldman Sachs to get a glimpse into the world of finance.<br/>",
        ...
        "It was my first experience software engineering and I learned a lot of new technologies, concepts, and patterns. However, I learned the most about the banking system, the culture of NYC, and what drives human progress."
    ]
};
// WebApp
tabs["WebApp"] = {
...
tabs["Chat"] = {
    ...
    "description": ["I integrated Symphony Chat into sale services applications to increase usability, further community involvement, and reduce the strain on developers."]
};
// BrandeisUniversity
tabs["BrandeisUniversity"] = {
    ...
    "description": ["I went to Brandeis University and double majored in Computer Science and Neuroscience.<br/>",
        "Much of my focus was using computing to advance the field of neuroscience rather than applying neuroscience applications to computing.<br/>",
        "Through computational modeling I discovered the joys of software development, which has led me on my current software engineering path.<br/>"
    ]
};
// Neuroscience
tabs["Neuroscience"] = {
    ...
    "description": ["Starting February 14th of my freshman year, I started working in Dr. Stephen Van Hooser's neuroscience laboratory. " +
        "The focus of the lab is to understand how neuronal circuits develop as a function of experience. I worked as a computational modeler.<br/>",
...
tabs["FirstModel"] = {
    "heading": "First Model",
    "image": "Images/M1.jpg",
    "description": ["My first project was to increase the speed of simulations for the computational model introduced in this <a target=\"blank\" href=\"http://jn.physiology.org/content/111/11/2355.long\">paper</a>.<br/>",
        ...
        "a C++ simulation environment that used Eulers Method to approximate differential equations, and a Matlab script to visualize CSV data.<br/>",
        "We were able to increase the speed of simulations by 10x! The source code is available at at my <a target=\"blank\" href=\"https://github.com/iankchristie/ModelEl\">Github</a>."
    ]
};
// JavaApplet
tabs["JavaApplet"] = {
    ...
    "description": ["While I was doing a lot of modeling I came across two problems:",
        ...
        "<li>It was difficult to communicate how the models worked.</li></ul>",
        "My solution was to develop a graphical model creation and visualization tool. It was a Java Applet that used a drag-and-drop design to create the model in a 2D space and used third-party libraries to visualize the output of simulations.<br/>",
        "It was used in my lab and as teaching tool in some classes for visualizing neuronal networks. The source code is available at my <a target=\"blank\" href=\"https://github.com/iankchristie/NeuronModelGUI\">Github</a>."
    ]
};
// Research
tabs["Research"] = {
    "heading": "Research",
    "image": "Images/M2.png",
    "description": ["During sophomore year I started my own computational neuroscience research project funded by an NIH grant. The goal of the project was to understand how a type of visual selectivity, called Direction Selectivity, developed. And to determine whether that development could take place entirely within the cortex, or if it had to rely on plasticity upstream in the brain.<br/>",
        "I created a generalizable model of a neuronal circuit that would take realistic input and determine an output as a firing rate. The firing rates of the system could be categorized. As a result each model could be thought of as an n-dimensional point in space, where each dimension was a parameter to the model and that point could be classified.",
        "So we scanned and classified the parameter space using Brandeis' Computational Cluster. Then we determined plasticity rules that would allow the model to go from one point in space to another simulating the training experience.<br/>",
        "I found two models that fit the biological data and made measurable predictions. Wet lab experiments are currently verifying those models.<br/>",
        "The research became my senior honors thesis and was awared <i>Highest Honors</i> and <i>The Division of Science Award for Outstanding Scientific Research</i>. The research was published by the Journal of Neuroscience <a target=\"blank\" href=\"https://www.ncbi.nlm.nih.gov/pubmed/28515285\">here</a>. It received recognition from <a target=\"blank\" href=\"http://blogs.brandeis.edu/science/2017/06/05/learning-to-see/\">Brandeis</a> " +
         "and the <a target=\"blank\" href=\"https://www.facebook.com/JournalofNeurophysiology/photos/a.312797488894767.1073741828.290827221091794/830765037098007/?type=3\">Journal</a>. The source code can be found at my <a target=\"blank\" href=\"https://github.com/iankchristie/Neuroscience\">Github</a>."
    ]
};
// TAing
tabs["TAing"] = {
    ...
    "description": ["Second to my love of learning is my love of teaching. I TA-ed for three classes at Brandeis starting sophomore year:",
...
tabs["Awards"] = {
    ...
    "description": ["<ul><li>Summa Cum Laude</li>" +
        "<li>Highest Honors for undergraduate thesis research</li>" +
        "<li>Phi Beta Kappa</li>" +
        "<li>Dean's List - all 7 semesters</li>" +
...
tabs["Personal"] = {
    ...
    "description": ["I like to think that I'm a interesting person.<br/>",
        "Most of my time is spent working, exercising, or sleeping. Though occasionally I've been known to socialize as well. Along with everyone else, I consider myself a film and music critic. Recently, I've been diving into physics books and documentaries. I try to better myself and learn whenever I can."
      ],
      "visited": 0
};
// Projects
...
tabs["iGel"] = {
    ...
    "description": ["The summer before going to college, I worked as a ranch hand in Sealy, TX, I played a lot of soccer, and I developed an iPhone app with a graduate student at the University of Texas Medical School.<br/>",
        "The idea was to reduce the cost and increase the availability of an instrument to document the results of an important scientific procedure called Gel Electrophoresis. The procedure is complicated but the instruments needed aren't.",
        "<ul><li>Gel</li><li>DNA</li><li>Batteries and wire</li><li>A box with a light</li><li>Camera</li></ul>",
        "At the time a few companies sold the UV light box and camera and packed them with unnecessary features to inflate the cost to about $5,000. Because of the cost most departments only have one documentation set up, which creates a bottle neck to productivity. Most experiments only requires an image of the gel to validate the procedure and the extra features are only necessary for paper images.<br/>",
        "To reduce the cost and increase productivity, our solution was to design a smaller UV box for the lab bench, so that an iPhone could be placed on it to take the picture. Next I used iOS Core Image libraries to process the image. If a paper image of the gel was needed then the more advanced hardware could be used.<br/>",
        "The code can be found at my <a target=\"blank\" href=\"https://github.com/iankchristie/iGel\">Github</a>."
    ]
};
// AirlessBreathalyzer
tabs["AirlessBreathalyzer"] = {
    ...
    "description": ["This was a really fun app that grew out of school project!<br/>",
        ...
        "The basic idea was to develop a phone based sobriety test. The app would have a number of activities to test and quantify:",
        "<ul><li>Balance</li><li>Reflexes</li><li>Cognitive impairement</li><li>Pupil dilation</li></ul>",
        "Then the app used machine learning to guess the user's Blood Alcohol Content (BAC). Of course, collecting the training data was the most fun part :).<br/>",
        "The app is not on my Github, but is currently being finished for release by my project partner <a target=\"blank\" href=\"https://www.linkedin.com/in/oscarcourchaine/\">Oscar Courchaine</a>."
    ],
};
// Foxus
tabs["Foxus"] = {
    ...
    "description": ["My attempt to un-fuck the internet. It's a really small Chrome extension that disables the Facebook newsfeed and removes images from YouTube. It's not the most complicated thing, but it was wildly successful in increasing my productivity. Big things come in small packages. Code can be found at my <a target=\"blank\" href=\"https://github.com/iankchristie/Foxus\">Github</a>."]
};
// BluetoothApp
tabs["BluetoothApp"] = {
...
tabs["Outdoor"] = {
    ...
    "description": ["A big part of my identity is my relationship to the outdoors, and I'm not picky.",
        ...
        "If it's outside and I'm using my body, I'm loving it. My philosophy is \"a fun weekend means all I want to do on Monday is sit on my ass and work until Friday.\""
    ]
};
// Biking
tabs["Biking"] = {
...
tabs["MS150"] = {
    ...
    "description": ["I started biking with my father and brother when I was 14 to prepare for a 190 mile two-day ride from Houston, TX to Austin, TX called the MS150. Since then I have done it 5 more times raising $2,400 to fight Multiple Sclerosis."]
};
// BikeAndBuild
tabs["BikeAndBuild"] = {
    "heading": "Bike & Build",
    "image": "Images/BnB.jpg",
    "description": ["Through service-oriented cross-country cycling trips, Bike & Build benefits affordable housing and empowers young adults to seek a lifetime of service and civic engagement.<br/>",
        ...
        "I then led a trip from Acadia, ME to New York City, NY in 2016. The position taught me a lot about leadership. I've raised $7,000 for affordable housing."
    ]
};
// RAMROD
tabs["RAMROD"] = {
...
tabs["RockClimbing"] = {
    ...
    "description": ["I started rock climbing about a year and a half ago and I'm in love with the sport. To me, rock climbing is a lot less about pushing my strength and climbing hard routes, and a lot more about pushing my technical abilities and climbing high. " +
        "My partner, Elizabeth, and I did a rock climbing road trip around the American West after graduating from college and before starting our jobs. We climbed at: " +
...
tabs["MountainClimbing"] = {
    ...
    "description": ["I started rock climbing so I could be more technically skilled on alpine routes, which is where my true heart lies. Notable ascents include:",
        "<ul><li>Mt. Kilimanjaro</li><li>Mt. Rainier</li><li>Chilean Northern Ice Sheet</li><li>Seven Fingered Jack</li><li>Mt. Reynolds & Mt. Clements in Glacier National Park</li><li>A bunch of Colorado 14ers</li></ul>",
...
tabs["BoyScouts"] = {
    ...
    "description": ["I'm an Eagle Scout and proud. Scouts taught me to be trustworthy, loyal, helpful, friendly, courteous, kind, obedient, cheerful, thrifty, brave, clean, and reverent.<br/>",
        "In addition, Scouts gave me some of the best friends and experiences I could have asked for.<br/>",
