...
tabs["Contact"] = {
    ...
    "description": ["<a target=\"blank\" href=\"mailto:iankchristie@gmail.com\">email: iankchristie@gmail.com</a>",
        "<a target=\"blank\" href=\"https://facebook.com/iankchristie\">Facebook: iankchristie</a>",
        "<a target=\"blank\" href=\"https://www.linkedin.com/in/iankchristie/\">Linkedin: iankchristie</a>",
        "<a target=\"blank\" href=\"https://github.com/iankchristie\">Github: iankchristie</a>",
        "TODO: resume"
    ]
};
// Professional
...
tabs["Chrome"] = {
    "heading": "Chrome",
    "image": "https://www.seeklogo.net/wp-content/uploads/2014/10/Google-Chrome-logo-vector-download.png",
    "description": ["The Chrome browser was amazing to work on! It was my first experience working on a <i>civilization sized</i> product and the engineering on the team is phenomenal. I worked on an experimental project called <b>The Physical Web</b>, which was a way to introduce the <b>Internet Of Things</b> into Chrome. I worked on the Chrome for Android and here is what I did:",
        "<ul><li>Developed a feature in Chrome to wirelessly share links over BLE with nearby Android users</li>" +
        "<li>Prototyped and optimized peer-to-peer webpage transfer over BLE from Raspberry Pi 3 to Android. Achieved a transfer rate of 32.8 KB/s (7.5x faster than previous attempts).</li>" +
        "<li>Enhanced UX of Physical Web prototype app by moving work off of main thread to reduce dropped frames.</li>" +
        "<li>Refactored Chrome share sheet to allow for easy inclusion of generic components with intent filters.</li></ul>"
    ]
};
// YouTube
tabs["YouTube"] = {
    "heading": "YouTube",
    "image": "https://www.seeklogo.net/wp-content/uploads/2016/06/YouTube-icon-400x400.png",
    "description": ["I'm currently on the YouTube team and loving it! I work on Client Infractructure under Mobile Architecture and specifically Offline Services on iOS (it's a mouthful). Here is what I've done: ",
        "<ul><li>Completed end-to-end intelligent playlist sync strategy to ensure that Youtube Red and emerging market users consistently have access to offline content.</li>" +
        "<li>Migrated iOS client infrastructure dependency injection framework.</li>" +
        "<li>Analyzed lightweight Core Data migration and its effect on application startup time.</li>"
    ]
};
// GoldmanSachs
tabs["GoldmanSachs"] = {
    "heading": "Goldman Sachs",
    "image": "http://1000logos.net/wp-content/uploads/2016/12/Goldman-Sachs-Logo.png",
